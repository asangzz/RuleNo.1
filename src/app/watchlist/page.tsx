...
import { DEFAULT_MOS_PERCENTAGE, DEFAULT_GROWTH_RATE } from "@/lib/rule-one";
...
export default function WatchlistPage() {
  ...
  const handleAddItem = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setNewTicker("");
      setFormData({ name: "", currentPrice: 0, eps: 0, growthRate: DEFAULT_GROWTH_RATE, historicalHighPE: 20 });
      setIsAdding(false);
      fetchWatchlist();
    } catch (error) {
