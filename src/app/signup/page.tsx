  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh]">
      <div className="w-full max-w-md p-8 bg-card border border-border rounded-2xl shadow-sm">
        <h2 className="text-2xl font-bold mb-6 text-center">Join Rule No. 1</h2>
        <p className="text-muted-foreground text-center mb-8">Start your journey to becoming a Rule No. 1 investor.</p>
