          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                ...
                className="w-full mt-2 bg-background border border-border rounded-md p-2 focus:outline-none focus:ring-1 focus:ring-accent transition-all"
              >
            ...
            <div>
              ...
              <div className="flex items-center gap-4 mt-2">
                ...
                />
                <span className="text-xl font-bold w-12">{settings.targetMOS}%</span>
              </div>
              <p className="text-xs text-muted-foreground mt-2">
                Rule No. 1 recommends a 50% Margin of Safety.
              </p>
            </div>
          </div>
        </section>
